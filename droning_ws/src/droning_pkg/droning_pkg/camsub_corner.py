...
from cornercontours import contourCornerSquares
...
class CamSubscriber(Node):
    ...
    def cam_callback(self, msg):                                                             
        ...
        if(self.camcounter % 5 == 0):
            ...
            #markAruco(cv2_img)
            frame, position2, qr_distance = contourCornerSquares(cv2_img)
            ...
            #Moving towards the center
                ...
                msg.linear.z = -15.0
                self.cmdvel_publisher.publish(msg)
            elif(qr_distance < 250 and abs(position2[0])<100 and abs(position2[1])<190):
            ...
            if(qr_distance > 250 and abs(position2[0])<100 and abs(position2[1])<190):
                msg = Twist()
                msg.linear.y = 22.0
